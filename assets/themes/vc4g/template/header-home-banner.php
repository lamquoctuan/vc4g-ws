...
<header>
    <div class="container">
        ...
        <div class="intro-text">
            <div class="intro-lead-in">Instant Cash for Gold, Silver</div>
            <div class="intro-heading">especially Diamond<acronym title=""><img src="/assets/images/logo-gia-small.jpg" alt=""></acronym></div>
