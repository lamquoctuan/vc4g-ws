...
?>
            ...
            <div class="col-sm-3 mt30 sidebar-whywepay">
                <div class="calculator mt40">
                    ...
                    <div class="bar-prd">
                        <a class="active" href="#calcGold" aria-controls="calcGold" role="tab" data-toggle="tab">Gold</a>
                        <a href="#calcSilver" aria-controls="calcSilver" role="tab" data-toggle="tab">Silver</a>
                    </div>
