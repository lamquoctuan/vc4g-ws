<div class="container text-center">
    ...
    <div class="row">
        <div class="col-sm-5 col-md-6 text-right"><button type="submit" class="btn body-content mt20" onclick="window.location.href='/in-store-person/';"><span class="btn1">In-store service</span></div>
